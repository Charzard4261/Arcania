...
public class ArcaniumPowder extends Page {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		gui.getFontRenderer().drawString("making it very hard to", leftX, lineOneY + lineOffsetY * 2, 0x000000, false);
		gui.getFontRenderer().drawString("gather the raw form", leftX, lineOneY + lineOffsetY * 3, 0x000000, false);
		...
		gui.getFontRenderer().drawString("to displace the", rightX, lineOneY + lineOffsetY * 2, 0x000000, false);
